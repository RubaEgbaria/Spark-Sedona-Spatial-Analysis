error id: file:///C:/Users/rubae/IdeaProjects/sedona/src/main/scala/main.scala:sql.
...
FROM filtered_data_table
    ...
    val avgDistanceKmDf = spark.sql("""
      SELECT 
          subcategory,
          AVG(ST_Distance(a.geom, b.geom)) * 111 AS avg_distance_km
      FROM spatial_data_table a
    ...
    """)
    avgDistanceKmDf.show(50, false)

  // creating a map of the businesses 
  val geoDf = spark.s@@ql("""
    SELECT
      sector,
      category,
      subcategory,
